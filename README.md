...
cost, forever**) and [`openspec/changes/flexi-worker-cloud/`](./openspec/changes/flexi-worker-cloud/)
...
| `daemon/`   | Rust workspace: `flexi-core` (shared wire schema) and `flexi-daemon` (the agent). |
